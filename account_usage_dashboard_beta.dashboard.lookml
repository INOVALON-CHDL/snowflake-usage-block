- dashboard: snowflake_usage_beta
  title: Snowflake Usage Beta
  layout: newspaper
  elements:
  - title: Data Loading
    name: Data Loading
    model: snowflake_usage_block_beta
    ...
    y_axes: [{label: Rows Loaded, orientation: left, series: [{id: load_history.total_row_count,
            ...
            __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
        ...
        type: linear, __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
        __LINE_NUM: 600}]
  ...
  - title: Query Volume and Runtime
    ...
    y_axes: [{label: Query Run Count, orientation: left, series: [{id: query_history.query_count,
            name: Query History Query Count, axisId: query_history.query_count, __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
            __LINE_NUM: 1058}], showLabels: true, showValues: true, valueFormat: '[>=1000000]0.00,,"M";[>=1000]0.00,"K";0.00''',
        unpinAxis: false, tickDensity: default, tickDensityCustom: 5, type: linear,
        __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml, __LINE_NUM: 1055},
      {label: Average Query Execution TIme (seconds), orientation: left, series: [
          {id: query_history.average_execution_time, name: Query History Average Execution
              Time, axisId: query_history.average_execution_time, __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
            __LINE_NUM: 1071}], showLabels: true, showValues: true, valueFormat: '0',
        unpinAxis: false, tickDensity: default, tickDensityCustom: 5, type: linear,
        __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml, __LINE_NUM: 1068}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
    y_axis_tick_density_custom: 5
  ...
  - title: Total Jobs by Warehouse (MTD)
    ...
    y_axes: [{label: Job Count, maxValue: !!null '', minValue: !!null '', orientation: left,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: query_history.count,
            name: Query History, axisId: query_history.count, __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
            __LINE_NUM: 114}], __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
        __LINE_NUM: 102}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - title: Billable TB by Month
    ...
    y_axes: [{label: Billable Tb, orientation: left, series: [{id: storage_usage.billable_tb,
            name: Storage Usage Billable Tb, axisId: storage_usage.billable_tb, __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
            __LINE_NUM: 982}], showLabels: true, showValues: true, unpinAxis: false,
        tickDensity: default, tickDensityCustom: 5, type: linear, __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
        __LINE_NUM: 979}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - title: Average Execution Time by Query Type and Warehouse Size (MTD)
    ...
    y_axes: [{label: Avg Execution Time (secs), maxValue: !!null '', minValue: !!null '',
        ...
        series: [{id: query_history.average_execution_time, name: Average Execution
              Time, axisId: query_history.average_execution_time, __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
            __LINE_NUM: 762}], __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
        __LINE_NUM: 750}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - title: Average Execution Time by User (MTD)
    ...
    y_axes: [{label: Avg Execution Time (secs), maxValue: !!null '', minValue: !!null '',
        ...
        series: [{id: query_history.average_execution_time, name: Average Execution
              Time, axisId: query_history.average_execution_time, __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
            __LINE_NUM: 188}], __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
        __LINE_NUM: 176}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - title: Database Storage Growth
    ...
    y_axes: [{label: Billable Tb, orientation: left, series: [{id: CCDB - storage_usage.billable_tb,
            name: CCDB, axisId: storage_usage.billable_tb, __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
            __LINE_NUM: 881}, {id: DATABLOCKS - storage_usage.billable_tb, name: DATABLOCKS,
            axisId: storage_usage.billable_tb, __FILE: snowflake_usage_block_beta/account_usage_dashboard.dashboard.lookml,
